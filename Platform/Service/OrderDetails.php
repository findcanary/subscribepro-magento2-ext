...
class OrderDetails extends AbstractService
{
     ...
     */
    public function createOrderDetails(array $orderDetailsData = [], int $websiteId = null): DataInterface
    {
     ...
     */
    public function saveOrderDetails(OrderDetailsInterface $orderDetails, int $websiteId = null): DataInterface
    {
